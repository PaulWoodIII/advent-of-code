...
import 'package:aoc_workspace/years/year2024/day19.dart';
import 'package:test/test.dart';

void main() {
  group('Year2024Day19', () {
    late Year2024Day19 solver;
    late InputLoader inputLoader;

    setUp(() {
      solver = Year2024Day19();
    ...
    group('Part 1', () {
      test('solves example input correctly', () {
        ...
        expect(result, '6'); // 6 designs are possible
      });
    ...
    group('Part 2', () {
      test('solves example input correctly', () {
        ...
        expect(result, '16'); // 2 + 1 + 4 + 6 + 1 + 2 = 16 total ways
      });
