...
import 'package:aoc_workspace/years/year2024/day07.dart';
import 'package:test/test.dart';

void main() {
  group('Year2024Day07', () {
    late Year2024Day07 solver;
    late InputLoader inputLoader;

    setUp(() {
      solver = Year2024Day07();
    ...
    group('Part 1', () {
      test('solves example input correctly', () {
        ...
        expect(result, '3749'); // Sum of test values: 190 + 3267 + 292
      });
    ...
    group('Part 2', () {
      test('solves example input correctly', () {
        ...
        expect(result, '11387'); // Sum of all 6 test values: 190 + 3267 + 292 + 156 + 7290 + 192
      });
