...
import 'package:aoc_workspace/years/year2024/day16.dart';
import 'package:test/test.dart';

void main() {
  group('Year2024Day16', () {
    late Year2024Day16 solver;
    late InputLoader inputLoader;

    setUp(() {
      solver = Year2024Day16();
    ...
    group('Part 1', () {
      test('solves example input correctly', () {
        ...
        expect(result, '7036'); // Expected result from puzzle example
      });
    ...
    group('Part 2', () {
      test('solves example input correctly', () {
        ...
        expect(result, '45'); // Expected result from puzzle example (45 tiles on optimal paths)
      });
