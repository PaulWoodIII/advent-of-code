...
import 'package:aoc_workspace/years/year2024/day13.dart';
import 'package:test/test.dart';

void main() {
  group('Year2024Day13', () {
    late Year2024Day13 solver;
    late InputLoader inputLoader;

    setUp(() {
      solver = Year2024Day13();
    ...
    group('Part 1', () {
      test('solves example input correctly', () {
        ...
        expect(result, '480'); // Expected result from puzzle example
      });
    ...
    group('Part 2', () {
      test('solves example input correctly', () {
        ...
        expect(result, '875318608908'); // Expected result from puzzle example (machines 2 and 4)
      });
